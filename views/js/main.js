...
var resizePizzas = function(size) {
  ...
  // I deleted the middle steps regarding pixels, and stuck just to percentages
  ...
  changeSliderLabel(size);
    ...
    // Changes the pizza's size based on selection
    function changePizzaSizes(size) {
      ...
      // This brings the read step out of the loop just below it.
...
function updatePositions() {
  ...
  // The next seven lines of code bring the read step out of the loop just below it.
  var scrollTopResult = document.body.scrollTop / 1250;

  // As i % 5 is actually only a revolving set of five numbers, I used that to
  //calculate the phase, and put the numbers together in an array.
  for (var i = 0; i < 5; i++) {
    phaseArray.push(Math.sin(scrollTopResult + i));
  }
...
var movingPizzos = document.getElementById("movingPizzas1");
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  var s = 256;
  var elem;
  var  numberOfPizzas = innerHeight / s * cols;
